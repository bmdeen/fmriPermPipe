...
if ashsExists
    ...
    fpp.func.surfaceResample(ashsPath,midthickPaths,maskAtlasPaths,ashsCiftiPath,...
        'subcortSegPath',subcortSegIndivFuncResPath,'isLabel',1,...
        'referenceFuncResPath',subcortSegIndivFuncResPath,'mapNames','ASHS');
    fpp.func.surfaceResample(ashsPath,midthickFsLRPaths,maskAtlasFsLRPaths,ashsCiftiFsLRPath,...
        'subcortSegPath',subcortSegIndivFuncResPath,'isLabel',1,...
