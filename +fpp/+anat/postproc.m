...
if ashsExists
    ...
    fpp.func.surfaceResample(ashsPath,inputSurfacePaths,maskAtlasPaths,ashsCiftiPath,...
        'subcortSegPath',subcortSegIndivFuncResPath,'isLabel',1,...
        'referenceFuncResPath',subcortSegIndivFuncResPath,'mapNames','ASHS');
    fpp.func.surfaceResample(ashsPath,inputSurfaceFsLRPaths,maskAtlasFsLRPaths,ashsCiftiFsLRPath,...
        'subcortSegPath',subcortSegIndivFuncResPath,'isLabel',1,...
