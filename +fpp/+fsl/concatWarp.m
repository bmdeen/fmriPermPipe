...
if ~((~isempty(premat) && ~isempty(fieldnames(fpp.bids.getMetadata(premat)))) || ...
        (~isempty(warp1) && ~isempty(fieldnames(fpp.bids.getMetadata(warp1)))) || ...
        (~isempty(midmat) && ~isempty(fieldnames(fpp.bids.getMetadata(midmat)))) || ...
        (~isempty(warp2) && ~isempty(fieldnames(fpp.bids.getMetadata(warp2)))) || ...
        (~isempty(postmat) && ~isempty(fieldnames(fpp.bids.getMetadata(postmat)))))
